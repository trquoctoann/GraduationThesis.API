...
public class Filter<FIELD_TYPE> implements Serializable {
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return (
                Objects.equals(this.equals, filter.equals) &&
                Objects.equals(this.notEquals, filter.notEquals) &&
                Objects.equals(this.specified, filter.specified) &&
                Objects.equals(this.in, filter.in) &&
                Objects.equals(this.notIn, filter.notIn)
            );
        } else {
            return false;
        }
