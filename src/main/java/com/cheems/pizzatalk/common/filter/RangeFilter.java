package com.cheems.pizzatalk.common.filter;
...
public class RangeFilter<FIELD_TYPE extends Comparable<? super FIELD_TYPE>> extends Filter<FIELD_TYPE> {
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            if (!super.equals(o)) {
                ...
                return (
                    Objects.equals(this.greaterThan, that.greaterThan) &&
                    Objects.equals(this.lessThan, that.lessThan) &&
                    Objects.equals(this.greaterThanOrEqual, that.greaterThanOrEqual) &&
                    Objects.equals(this.lessThanOrEqual, that.lessThanOrEqual)
                );
            }
        } else {
            return false;
    ...
    public int hashCode() {
        return Objects.hash(
            new Object[] { super.hashCode(), this.greaterThan, this.lessThan, this.greaterThanOrEqual, this.lessThanOrEqual }
        );
    }
